...
<div class="min-w-0 flex-1">
    <h2 class="text-2xl/7 font-bold text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">Daftar Pengajuan</h2>
  </div>
      </div>
  ...
  <section aria-labelledby="filter-heading">
    ...
    <div class="border-b border-gray-200 bg-white pb-4">
      <div class="flex items-center justify-between px-4 sm:px-6 lg:px-0 lg:w-full">
        ...
        <form id="filterForm" method="GET" action="{{ route('daftar-pengajuan') }}" class="space-y-4">
        ...
        <table class="min-w-full divide-y divide-gray-300" id="resultTable">
          <thead>
            <tr>
              ...
              <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Jenis Pengajuan</th>
              ...
              <td class="py-5 pr-3 pl-4 text-sm whitespace-nowrap sm:pl-0">
                <div class="flex items-center">
                  ...
                  <div class="ml-4">
                    ...
                    <div class="mt-1 text-gray-500">{{ $pengajuan ->identitasLks->dataUmum->kecamatan ?? '' }}</div>
                  </div>
                </div>
              </td>
              <td class="px-3 py-5 text-sm whitespace-nowrap text-gray-500">
                <div class="text-gray-900">{{ $pengajuan->tipe_pengajuan ?? '-' }}</div>
